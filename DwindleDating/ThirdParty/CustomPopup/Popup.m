...
#define FlatWhiteColor      [UIColor colorWithRed:220/255.0 green:234/255.0 blue:238/255.0 alpha:1] /*#eff1f5*/
#define FlatWhiteDarkColor  [UIColor colorWithRed:220/255.0 green:234/255.0 blue:238/255.0 alpha:1] /*#dfe1e8*/
#define ColorSubTitle       [UIColor colorWithRed:127/255.0 green:127/255.0 blue:127/255.0 alpha:1]
#define ColorTitle          [UIColor colorWithRed:108/255.0 green:107/255.0 blue:114/255.0 alpha:1]
#define ColorCancelButton   [UIColor colorWithRed:0.91 green:0.184 blue:0.184 alpha:1]
#define ColorSuccesButton   [UIColor colorWithRed:14/255.0 green:130/255.0 blue:167/255.0 alpha:1]
...
- (void)setupTitle {
    ...
    if (pTitle) {
        if (!titleLabel) {
            ...
            [titleLabel setTextColor:ColorTitle /*#546595*/];
        }
...
- (void)setupSubtitle {
    ...
    if (pSubTitle) {
        ...
        if (!subTitleLabel) {
            ...
            [subTitleLabel setTextColor:ColorSubTitle];
...
- (void)setupButtons {
    ...
    if (pCancelTitle) {
        ...
        if (!cancelBtn) {
            ...
            [cancelBtn setBackgroundColor:ColorCancelButton /*#e82f2f*/];
    ...
    if (pSuccessTitle) {
        ...
        if (!successBtn) {
            ...
            [successBtn setBackgroundColor:ColorSuccesButton /*#687aae*/];
