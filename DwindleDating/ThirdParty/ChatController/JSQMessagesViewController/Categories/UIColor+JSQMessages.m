...
+ (UIColor *)jsq_messageBubbleGreenColorDwindleDating
{
    return [UIColor colorWithRed:0 green:129/255.0 blue:173/255.0 alpha:1.0];
}

+ (UIColor *)jsq_messageBubbleGrayColorDwindleDating
{
    return [UIColor colorWithRed:208/255.0 green:214/255.0 blue:218/255.0 alpha:1.0];
}
